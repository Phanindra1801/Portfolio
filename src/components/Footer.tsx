      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-400 max-w-md">
              A passionate full-stack developer focused on creating beautiful, functional, and user-friendly applications.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                ...
                <a href="mailto:22000031333cseh@gmail.com" className="hover:text-blue-400 transition-colors duration-300">22000031333cseh@gmail.com</a>
              </li>
              <li className="text-gray-400">
                <span className="block">Phone:</span>
                <a href="tel:+919392978076" className="hover:text-blue-400 transition-colors duration-300">+91 9392978076</a>
              </li>
              <li className="text-gray-400">
                <span className="block">Location:</span>
                <span>K L University ,Andhra Pradesh</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">
            © {currentYear} Phanindra Marisetti. All rights reserved. Made with <Heart className="inline w-4 h-4 text-red-500" />
          </p>
        </div>
      </div>
    </footer>
