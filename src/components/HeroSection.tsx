  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-blue-500 hover:bg-blue-600 text-white p-3 rounded-full shadow-lg transition-transform hover:scale-110"
      >
      ...
      {/* Chatbot Iframe */}
      {showChatbot && (
        <div className="fixed bottom-20 right-6 w-[360px] h-[600px] bg-white rounded-lg shadow-xl z-50 overflow-hidden">
          <iframe
            src="https://www.chatbase.co/chatbot-iframe/ASt3A4-LL9EXuHai1s6cG"
            width="100%"
            style={{ height: '100%' }}
            frameBorder="0"
          />
